...
feature=onehotencoder.encodedlist()
...
label,rangelabel=onehotencoder.makelabel()
...
tuned_parameters = [{'kernel': ['rbf'], 'gamma': [0.1,0.01],'C': [10,1,0.1,0.01], 'epsilon':[0.001,0.0001]}]
